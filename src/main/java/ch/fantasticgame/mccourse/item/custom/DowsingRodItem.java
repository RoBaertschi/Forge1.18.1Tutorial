package ch.fantasticgame.mccourse.item.custom;

import ch.fantasticgame.mccourse.item.ModItems;
import ch.fantasticgame.mccourse.util.InventoryUtil;
...
public class DowsingRodItem extends Item {
    ...
    private void outputValuableCordinates(BlockPos blockPos, Player player, Block blockBelow) {
        player.sendMessage(new TextComponent("Found " + blockBelow.asItem().getRegistryName().toString() + " at" +
                "(" + blockPos.getX() + ", " + blockPos.getY() + ", " + blockPos.getX() + ")"), player.getUUID());
    }
